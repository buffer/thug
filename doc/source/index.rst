...
Currently 8 Internet Explorer (Windows XP, Windows 2000 and Windows 7), 6 Chrome (Windows XP,
Windows 7, MacOS X, Android 4.0.3, Linux), 2 Firefox (Windows XP, Linux) and 3 Safari (Windows XP,
Windows 7, MacOS X) personalities are emulated and about 90 vulnerability modules (ActiveX controls,
core browser functionalities, browser plugins) are provided.
