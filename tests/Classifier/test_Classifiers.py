...
class TestClassifiers:
    ...
    def do_perform_test(self, caplog, sample, expected):
        ...
        thug.add_cookieclassifier(
            os.path.join(self.signatures_path, "cookie_signature_8.yar")
        )
        thug.add_sampleclassifier(
            os.path.join(self.signatures_path, "sample_signature_10.yar")
        )
        ...
        thug.add_samplefilter(
            os.path.join(self.signatures_path, "sample_filter_11.yar")
        )
        ...
        log.ImageClassifier.classify(
            "https://buffer.antifork.org/images/antifork.jpg", "Antifork"
        )
        log.ImageClassifier.classify(
            "https://buffer.antifork.org/images/antifork.jpg", "Antifork"
        )
    ...
    def test_html_classifier_1(self, caplog):
        ...
        expected = [
            "[HTML Classifier] URL: test1.html (Rule: html_signature_1, Classification: strVar)"
        ]
    ...
    def test_html_filter_2(self, caplog):
        ...
        expected = [
            "[HTMLFILTER Classifier] URL: test2.html (Rule: html_filter_2, Classification: )"
        ]
    ...
    def test_js_filter_2(self, caplog):
        sample = os.path.join(self.samples_path, "test2.html")
        expected = [
            "[JSFILTER Classifier] URL: test2.html (Rule: js_signature_2, Classification: )"
        ]
    ...
    def test_text_classifier_5(self, caplog):
        ...
        expected = [
            "[TEXT Classifier] URL: test5.html (Rule: text_signature_5, Classification: )"
        ]
    ...
    def test_text_filter_5(self, caplog):
        sample = os.path.join(self.samples_path, "test5.html")
        expected = [
            "[TEXTFILTER Classifier] URL: test5.html (Rule: text_signature_5, Classification: )"
        ]
    ...
    def test_vbs_filter_6(self, caplog):
        ...
        expected = [
            "[VBSFILTER Classifier] URL: test6.html (Rule: vbs_signature_6, Classification: )"
        ]
    ...
    def test_cookie_classifier_8(self, caplog):
        ...
        expected = [
            "[COOKIE Classifier] URL: cookie1.txt (Rule: cookie_signature_8, Classification: )"
        ]
    ...
    def test_cookie_filter_9(self, caplog):
        ...
        expected = [
            "[COOKIEFILTER Classifier] URL: cookie2.txt (Rule: cookie_filter_9, Classification: )"
        ]
    ...
    def test_sample_signature_10(self, caplog):
        ...
        expected = [
            "[SAMPLE Classifier] URL: 52bfb8491cbf6c39d44d37d3c59ef406 (Rule: sample_signature_10, Classification: )"
        ]
    ...
    def test_sample_filter_11(self, caplog):
        sample = os.path.join(self.test_files_path, "sample.exe")
        expected = [
            "[SAMPLEFILTER Classifier] URL: 52bfb8491cbf6c39d44d37d3c59ef406 (Rule: sample_filter_11, Classification: )"
        ]
