...
class TestExtensive(object):
    ...
    def test_Anchor7(self, caplog):
        ...
        expected = [
            "[MIMEHandler] Unknown MIME Type: application/font-woff2",
        ]
    ...
    def test_Anchors1(self, caplog):
        ...
        expected = [
            "[window open redirection] about:blank -> https://buffer.antifork.org/westwood/westwood.html",
    ...
    def test_Anchors2(self, caplog):
        ...
        expected = [
            "[document.write] Deobfuscated argument: <a>Google</a>",
        ]
