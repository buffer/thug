...
class TestMiscSamplesIE(object):
    ...
    def test_testMicrosoftXMLHTTPEvent4(self, caplog):
        ...
        expected = [
            "[Microsoft XMLHTTP ActiveX] open('POST', 'http://192.168.1.100', True, 'foo', 'bar')",
    ...
    def test_testMicrosoftXMLHTTPEvent5(self, caplog):
        ...
        expected = ["[Window] Alert Text: Request completed", "[JNLP Detected]"]

        self.do_perform_test(caplog, sample, expected)

    def test_testMicrosoftXMLHTTPEvent6(self, caplog):
        sample = os.path.join(self.misc_path, "testMicrosoftXMLHTTPEvent6.html")
        expected = ["[Window] Alert Text: Request completed", "[JSON redirection]"]
    ...
    def test_testCCInterpreter(self, caplog):
        ...
        expected = ["JavaScript version: 9", "Running on the 32-bit version of Windows"]
        self.do_perform_test(caplog, sample, expected)
    ...
    def test_testDocumentFragment4(self, caplog):
        ...
        expected = [
            '<div><p>Test2</p></div><div><p>Test</p></div><div id="test1"><p>Test 1</p></div>',
        ]
    ...
    def test_testDocumentFragment5(self, caplog):
        ...
        expected = [
            "Trying to replace a node not in the tree",
    ...
    def test_testDOMImplementation2(self, caplog):
        ...
        expected = [
            "Element #1: [object HTMLHeadElement]",
    ...
    def test_testObject2(self, caplog):
        ...
        expected = [
            "[params redirection] about:blank -> http://192.168.1.100/data",
    ...
    def test_testObject3(self, caplog):
        ...
        expected = [
            "[params redirection] about:blank -> http://192.168.1.100/movie.swf"
        ]
    ...
    def test_testObject7(self, caplog):
        ...
        expected = ["width: 400", "foo: undefined", "foo: bar"]
    ...
    def test_testScriptingEncoder(self, caplog):
        ...
        expected = [
            '[Scripting.Encoder ActiveX] EncodeScriptFile(".js", "alert("test");", 0, ""',
        ]
    ...
    def test_testHTMLImageElement2(self, caplog):
        ...
        expected = [
            "Alert Text: Inside onerror handler",
    ...
    def test_testMicrosoftXMLDOM(self, caplog):
        ...
        expected = [
            "[Microsoft XMLDOM ActiveX] Creating element TEST",
            "bin.base64",
            "foobar3: foobar3",
            "bin.hex",
            "foobar4: foobar4",
    ...
    def test_testWinNTSystemInfo(self, caplog):
        ...
        expected = [
            "[WScript.Shell ActiveX] CreateObject (WinNTSystemInfo)",
    ...
    def test_testDump(self, caplog):
        ...
        expected = [
            "[eval] Deobfuscated argument: eval",
    ...
    def test_testTimers(self, caplog):
        ...
        expected = ["setTimeout null expression", "setInterval null expression"]
    ...
    def test_testClearTimeout(self, caplog):
        ...
        expected = ["Alert Text: 1", "Alert Text: 2"]
    ...
    def test_testJScriptEncode(self, caplog):
        ...
        expected = [
            "this code should bE kept secret!!!!",
        ]
    ...
    def test_testIEVisibility(self, caplog):
        ...
        expected = [
            "[Window] Alert Text: document.msHidden: false",
    ...
    def test_testSplitText(self, caplog):
        ...
        expected = [
            "p.childNodes.length before splitText: 1",
    ...
    def test_testNormalize(self, caplog):
        ...
        expected = [
            "[Before normalize] wrapper.childNodes.length: 6",
    ...
    def test_testClearAttributes(self, caplog):
        ...
        expected = ["id: myMarquee", "style: border:2px solid blue", "bgcolor: null"]
    ...
    def test_testScriptingDictionary(self, caplog):
        ...
        expected = [
            '[Scripting.Dictionary ActiveX] Add("0", "1")',
